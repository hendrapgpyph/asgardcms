<template>
  <div>
    ...
    <button
      v-shortkey="['c']"
      @shortkey="pushRoute({ name: 'admin.user.roles.create' })"
      v-show="false"
    ></button>
  </div>
</template>
...
export default {
  ...
  methods: {
    queryServer(customProperties) {
      ...
      axios
        .get(
          route("api.user.role.index", _.merge(properties, customProperties))
        )
        .then((response) => {
