  ...
  <div>
    <div class="row page-titles">
      <div class="col-md-5 align-self-center">
        <h3 class="text-themecolor">{{ trans(`roles.${pageTitle}`) }}</h3>
      </div>
              ...
              <div class="card-body">
                <el-tabs>
                  <el-tab-pane :label="trans('roles.tabs.data')">
                    ...
                    <el-form-item
                      :label="trans('roles.form.slug')"
                      :class="{
                        'el-form-item is-error': form.errors.has('slug'),
                      }"
                    >
                      <el-input v-model="role.slug">
                        <el-button slot-scope="prepend" @click="generateSlug"
                          >Generate</el-button
                        >
                      </el-input>
                      <div
    ...
    <button
      v-shortkey="['b']"
      @shortkey="pushRoute({ name: 'admin.user.roles.index' })"
      v-show="false"
    ></button>
  </div>
</template>
