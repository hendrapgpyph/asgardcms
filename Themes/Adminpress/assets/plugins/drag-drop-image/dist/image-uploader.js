    ...
    $.fn.imageUploader = function (options) {
        ...
        let createContainer = function () {
            ...
            $input = $('<input>', {
                ...
                multiple: '',
                class: 'upload-'+plugin.settings.imagesInputName,
                //onchange: "setInputFotoMultiple(this)"
            }).appendTo($container);
        ...
        let createImg = function (src, id, preloaded) {
            ...
            let $container = $('<div>', {class: 'uploaded-image'}),
                // create a href
                $ahref = $('<a>', {href: '#!'}).appendTo($container),
                
                // Create the img tag
                $img = $('<img>', {src: src}).appendTo($ahref),
            ...
            $ahref.attr("onclick","showGambarFancyBox('"+src+"')");
            ...
            $button.on("click", function (e) {
                ...
                $container.remove();
                plugin.settings.vmodel.splice($container.data('index'),1);
        ...
        let setPreview = function ($container, files) {
            ...
            // Run through the files
            $(files).each(function (i, file) {
                plugin.settings.vmodel.push(file);
